...
|Remapのキー名|機能|
|-|-|
|CMD / CTL|WindowsではControlキー、Apple製品ではCommandキー|
|Undo|Ctrl/Cmd + Z|
...
|Speed + Left|左手側の速度、感度を上げる|
|Speed - Left|左手側の速度、感度を下げる|
|Speed + Right|右手側の速度、感度を上げる|
|Speed - Right|右手側の速度、感度を下げる|
|Angle + Left|左手側の角度を増やす|
|Angle - Left|左手側の角度を減らす|
|Invert X Left|左手側の軸を片方反転させる|
|Mode Change Left|左手側の入力モードを変える|
|Angle + Right|右手側の角度を増やす|
|Angle - Right|右手側の角度を減らす|
|Invert X Right|右手側の軸を片方反転させる|
|Mode Change Right|右手側の入力モードを変える|
|Invert Scroll|スクロール方向を反転する|
|Scroll Mode|押している間だけトラックボール/ジョイスティックでスクロールできる|
|Toggle Auto Mouse|オートマウス機能の切り替え|
|OLED Mode|OLEDの機能の切り替え|
|QK_USER_0|短押しでESC、押している間スクロールモード|
|QK_USER_1|短押しでTab、押している間スクロールモード|
|QK_USER_2|短押しでかな、押している間スクロールモード|
|QK_USER_3|短押しで英数、押している間スクロールモード|
|QK_USER_4|押している間だけ減速モード|
|QK_USER_5|短押しでESC、押している間減速モード|
|QK_USER_6|短押しでTab、押している間減速モード|
|QK_USER_7|短押しでかな、押している間減速モード|
|QK_USER_8|短押しで英数、押している間減速モード|
|QK_USER_9|短押しで左クリック、押している間減速モード|
|QK_USER_10|短押しで右クリック、押している間減速モード|
|QK_USER_11|短押しで中クリック、押している間減速モード|
|QK_USER_12|押している間だけカーソル移動モード|
|QK_USER_13|押している間だけ十字キー入力モード|
|QK_USER_14|斜め入力防止のオンオフ|
|QK_USER_15|RGBレイヤー機能のオンオフ|
