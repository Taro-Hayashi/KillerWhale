...
## VIA用サンプルキーマップ
- 単体使用左手専用キーマップ [solo_left.layout.json](https://github.com/Taro-Hayashi/KillerWhale/releases/download/0.21.4.1/solo_left.layout.json)
- 単体使用右手専用キーマップ [solo_right.layout.json](https://github.com/Taro-Hayashi/KillerWhale/releases/download/0.21.4.1/solo_right.layout.json)
### ファームウェアのコード
